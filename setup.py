...
# -*- coding: utf-8 -*-
"""
    Setup file for matelight_scheduler.
...
MAIN_PACKAGE = "matelight_scheduler"
DESCRIPTION = "None"
LICENSE = "new BSD"
URL = "None"
AUTHOR = "Uwe Kamper"
EMAIL = "me@uwekamper.de"
...
# Add here console scripts like ['hello_world = matelight_scheduler.module:function']
CONSOLE_SCRIPTS = []
...
def setup_package():
    command_options = {
        ...
        'test': {'test_suite': ('setup.py', 'tests'),
                 'cov': ('setup.py', 'matelight_scheduler')}}
    if JUNIT_XML:
